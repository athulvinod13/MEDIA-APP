...
function Home() {
  ...
  return (
    ...
    <div className='container mt-5 mb-5 d-flex justify-content-between'>
      ...
      <Link to={'/watchhistory'} style={{textDecoration:'none',color:'black'}}>
      <button className='btn btn-success '><h4 className='text-light'>Watch History <i class="fa-solid fa-clock-rotate-left"></i></h4></button>
      </Link>
    </div>
